...
-- Please do not work/connect under the default 'postgres' role, create your own grp_033 role (033 is your group number)
...
-- -------------------------------
-- 2. Create the "student group" role (replace 033 with your three-digit group number). You can choose your own password for your role or just use this simple '123' password.
-- -------------------------------
DROP ROLE IF EXISTS grp_033;
CREATE ROLE grp_033 LOGIN PASSWORD '123';
GRANT CONNECT, CREATE ON DATABASE airq TO grp_033;
