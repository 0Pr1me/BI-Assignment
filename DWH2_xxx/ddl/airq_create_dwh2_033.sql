-- Make the A2's dwh2_033 schema the default for this session
SET search_path TO dwh2_033;

-- Create schema
-- CREATE SCHEMA IF NOT EXISTS dwh2_033;

-- -------------------------------
-- 2) DROP TABLE before attempting to create Star Schema tables, drop in dependency order (fact first)
-- -------------------------------
DROP TABLE IF EXISTS dwh2_033.ft_param_city_month CASCADE;
DROP TABLE IF EXISTS dwh2_033.dim_alertpeak CASCADE;
DROP TABLE IF EXISTS dwh2_033.dim_param CASCADE;
DROP TABLE IF EXISTS dwh2_033.dim_city CASCADE;
DROP TABLE IF EXISTS dwh2_033.dim_timemonth CASCADE;
